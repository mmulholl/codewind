...
class LoadTestCard extends React.Component {
    ...
    render() {
        ...
        let memoryFormatted = (memoryValue * 0.000000001).toFixed(1);
        ...
        let toolTipContentMemory = BuildToolTipContent(snapshot['memory'].value.value.data, 'MEMORY', 0.000000001, 1, "MB");

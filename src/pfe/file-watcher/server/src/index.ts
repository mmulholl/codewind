...
export default class Filewatcher {
     ...
     *                    build : {
     *                    files: [
     *                            ‘/microclimate-workspace/.logs/microclimate-dev-liberty-libertyapp.build.log’,
     *                             ‘/microclimate-workspace/.logs/microclimate-dev-liberty-libertyapp.docker_build.log’
     *                            ]
     *                            }
     *                     app: {
     *                            dir: ‘/microclimate-workspace/libertyapp/mc-target/liberty/wlp/usr/servers/defaultServer/logs/ffdc’  ,
     *                            files: [
     *                              ‘/microclimate-workspace/libertyapp/mc-target/liberty/wlp/usr/servers/defaultServer/logs/console.log’,
     *                              ‘/microclimate-workspace/libertyapp/mc-target/liberty/wlp/usr/servers/defaultServer/logs/messages.log’
     *                             ]
     *                           }
     *                   }
     * }
     ...
     *   location:     ‘/home/microclimate-workspace/microprofileapp1’
     ...
     *       "origin": "workspace",
     *       "files": [
     *          "/microclimate-workspace/.logs/spr-271c8f40-7721-11e9-81ae-6f8cd0194e7c/maven.build.log",
     *          "/microclimate-workspace/.logs/spr-271c8f40-7721-11e9-81ae-6f8cd0194e7c/docker.build.log"
     *       ]
     *   }
     * ```
     *
     ...
     *      "logs": {
     *          "build": {
     *              "file": "/microclimate-workspace/.logs/lib-c2281250-36b4-11e9-a069-19717268a986/maven.build.log"
     *          }
     *      }
     *  }
     * ```
     ...
     *
     * @example await filewatcher.getProjectTypes("/microclimate-workspace/microprofileapp1")
     *
     ...
     *              "file": [‘/microclimate-workspace/microprofileapp1/mc-target/liberty/wlp/usr/servers/defaultServer/logs/console.log’, ‘/microclimate-workspace/microprofileapp1/mc-target/liberty/wlp/usr/servers/defaultServer/logs/messages.log’],

...
public class SwiftImportFromPublicGit {

	private static String exposedPort;
	private static String projectName = "testswift" + SUITE_TYPES.importtest;
	...
	public void TestAimportFromGit(){
		...
		String urlParameters  ="{\"repo\": \"" + MicroclimateTestUtils.swiftPublicRepo+"\",\"name\": \"" + projectName +"\"}";
		try {
			...
			Logger.println(SwiftImportFromPublicGit.class, "TestAimportFromGit()", "Exception occurred during project import: " + e.getMessage(),e);
	...
	public void TestBcheckForProject() {
		try {
			while(true) {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestBcheckForProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
	...
	public void TestCcheckForContainer() {
		try {
			...
			assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestCcheckForContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestEcheckEndpoint() {
		...
		try {
			while(true) {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestEcheckEndpoint()", "Exception occurred when checking for endpoint",e);
	...
	public void TestFupdate() {
		...
		try {
			...
			Logger.println(SwiftImportFromPublicGit.class, "TestFupdate()", "Exception occurred when checking for endpoint: ",e);
			fail("Exception occurred when checking for endpoint");
		}
	}
	...
	public void TestGdelete() {
		...
		if (MicroclimateTestUtils.retryCount == retry.getRetriesLeft()) {
			try {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestGdelete()", "Exception occurred during project deletion: " + e.getMessage(),e);
		...
		if (testType.equalsIgnoreCase("local")) {
			...
			try {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check if container still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check if image still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestGdelete()", "Exception occurred during get pod: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check workspace: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check if pod still exists: " + e.getMessage(),e);

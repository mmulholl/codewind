...
public class MicroprofileProjectAPITests extends AbstractMicroclimateTest {
	...
	public void TestA009reconfigWatchedFilesNowatchedFilesORIgnoredFiles() {
		try {
			...
			String urlParameters = "{\"settings\": {\"watchedFiles\" : { \"dummyValue\": \"/microclimate-workspace/" + projectName + "/chart\" }}}";
	...
	public void TestA010reconfigWatchedFilesInvalidignoredFiles() {
		try {
			...
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String SettingsAPI = MicroclimateTestUtils.getSettingsAPI(projectID);
			String urlParameters = "{\"settings\": {\"watchedFiles\" : { \"excludeFiles\": \"/microclimate-workspace/" + projectName + "/chart\" }}}";
			MicroclimateTestUtils.PairedResponse pairedResponse = MicroclimateTestUtils.callAPIBodyParametersWSocketResponse(SettingsAPI, urlParameters, PROTOCOL, PORT, "POST", testType, eventsOfInterest, 20);
			int httpResult = pairedResponse.httpResponse.getResponseCode();
	...
	public void TestA011reconfigWatchedFiles() {
		try {
			...
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String SettingsAPI = MicroclimateTestUtils.getSettingsAPI(projectID);
			String urlParameters = "{\"settings\": {\"watchedFiles\" : { \"includeFiles\": [\"/microclimate-workspace/" + projectName + "/\"], \"excludeFiles\": [\"/microclimate-workspace/" + projectName + "/mc-target\", \"/microclimate-workspace/" + projectName + "/target\", \"/microclimate-workspace/" + projectName + "/src\"] }}}";
			MicroclimateTestUtils.PairedResponse pairedResponse = MicroclimateTestUtils.callAPIBodyParametersWSocketResponse(SettingsAPI, urlParameters, PROTOCOL, PORT, "POST", testType, eventsOfInterest, 20);
			int httpResult = pairedResponse.httpResponse.getResponseCode();
	...
	public void TestB001buildAndRun() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
	...
	public void TestB003buildAndRunInvalidProjectTypeNewProject() {
		...
		try {
			String urlParameters = "{\"projectID\": \"abcd" + "\",\"projectType\": \"libertyxxx\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
	...
	public void TestB005buildAndRunDifferentProjectTypeExistingProject() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"projectID\": \"" + projectID + "\",\"projectType\": \"spring\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
			HttpResponse httpResponse = MicroclimateTestUtils.callAPIBodyParameters(PROJECTS_API, urlParameters, PROTOCOL, PORT, "POST", testType);
			int httpResult = httpResponse.getResponseCode();
	...
	public void TestB006buildAndRunDifferentLocationExistingProject() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters  = "{\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + "\"}";
			HttpResponse httpResponse = MicroclimateTestUtils.callAPIBodyParameters(PROJECTS_API, urlParameters, PROTOCOL, PORT, "POST", testType);
			int httpResult = httpResponse.getResponseCode();
	...
	public void TestB007buildAndRunInvalidStartMode() throws Exception {
		...
		String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
		String urlParameters = "{\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + projectName + "\",\"startMode\": \"xxx\"}";
	...
	public void TestB008buildAndRunStartModeRun() throws Exception {
		...
		String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
		String urlParameters = "{\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + projectName + "\",\"startMode\": \"run\"}";
		String[] eventsOfInterest = {projectCreationEvent};
		MicroclimateTestUtils.PairedResponse pairedResponse = MicroclimateTestUtils.callAPIBodyParametersWSocketResponse(PROJECTS_API, urlParameters, PROTOCOL, PORT, "POST", testType, eventsOfInterest, 300);
		int httpResult = pairedResponse.httpResponse.getResponseCode();
	...
	public void TestB009buildAndRunStartModeDebug() throws Exception {
		...
		String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
		String urlParameters = "{\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + projectName + "\",\"startMode\": \"debug\"}";
		String[] eventsOfInterest = {projectCreationEvent};
		MicroclimateTestUtils.PairedResponse pairedResponse = MicroclimateTestUtils.callAPIBodyParametersWSocketResponse(PROJECTS_API, urlParameters, PROTOCOL, PORT, "POST", testType, eventsOfInterest, 300);
		int httpResult = pairedResponse.httpResponse.getResponseCode();
	...
	public void TestC001getProjectTypes() {
		try {
			String api = TYPES_API + "?location=/microclimate-workspace/" + projectName;
	...
	public void TestC002getProjectTypesInvalidLocation() {
		try {
			String api = TYPES_API + "?location=/microclimate-workspacexxx/" + projectName;
			String url = MicroclimateTestUtils.getBaseURL(testType, PORT, PROTOCOL) + api;
		    ...
		    {  
			    "logs": {
			        "build": {
			            "origin": "workspace",
			            "files": [
			                "/microclimate-workspace/.logs/lib-c2281250-36b4-11e9-a069-19717268a986/maven.build.log",
			                "/microclimate-workspace/.logs/lib-c2281250-36b4-11e9-a069-19717268a986/docker.build.log"
			            ]
			        },
			        "app": {
			            "origin": "workspace",
			            "dir": "/microclimate-workspace/microprofileapp1/mc-target/liberty/wlp/usr/servers/defaultServer/logs/ffdc",
			            "files": [
			                "/microclimate-workspace/microprofileapp1/mc-target/liberty/wlp/usr/servers/defaultServer/logs/messages.log",
			                "/microclimate-workspace/microprofileapp1/mc-target/liberty/wlp/usr/servers/defaultServer/logs/console.log"
			            ]
			        }
			    }
			}
	...
	public void TestE001actionInvalid() {
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"xxx\", \"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
			HttpResponse httpResponse = MicroclimateTestUtils.callAPIBodyParameters(ACTION_API, urlParameters, PROTOCOL, PORT, "POST", testType);
			int httpResult = httpResponse.getResponseCode();
	...
	public void TestE002actionValidate() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"validate\",\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
	...
	public void TestE003actionValidateInvalidLocation() {
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"validate\",\"projectID\": \"" + projectID + "\",\"projectType\": \"liberty\",\"location\": \"/microclimate-workspacexxx/" + projectName + "\"}";
			HttpResponse httpResponse = MicroclimateTestUtils.callAPIBodyParameters(ACTION_API, urlParameters, PROTOCOL, PORT, "POST", testType);
			int httpResult = httpResponse.getResponseCode();
	...
	public void TestE004actionValidateInvalidProjectType() {
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"validate\",\"projectID\": \"" + projectID + "\",\"projectType\": \"libertyxxx\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
			HttpResponse httpResponse = MicroclimateTestUtils.callAPIBodyParameters(ACTION_API, urlParameters, PROTOCOL, PORT, "POST", testType);
			int httpResult = httpResponse.getResponseCode();
	...
	public void TestE005actionValidateDifferentProjectTypeSpring() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"validate\",\"projectID\": \"" + projectID + "\",\"projectType\": \"spring\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
	...
	public void TestE006actionValidateDifferentProjectTypeNodeJS() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"validate\",\"projectID\": \"" + projectID + "\",\"projectType\": \"nodejs\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";
	...
	public void TestE007actionValidateDifferentProjectTypeSwift() {
		...
		try {
			String projectID = MicroclimateTestUtils.getProjectID(projectName, testType);
			String urlParameters = "{\"action\": \"validate\",\"projectID\": \"" + projectID + "\",\"projectType\": \"swift\",\"location\": \"/microclimate-workspace/" + projectName + "\"}";

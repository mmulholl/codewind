...
public class SwiftImportFromZip extends AbstractMicroclimateTest {

	private static String exposedPort;
	private static String projectName = "swiftzip" + SUITE_TYPES.importtest;
	...
	public void TestAimport(){
		try {
		Logger.println(SwiftImportFromZip.class, "TestAimport()", ">>> SwiftImportFromZip.TestAimport");
		String filePath = MicroclimateTestUtils.rescourceDir + "swiftzip.zip";
		int HttpResult = MicroclimateTestUtils.importLocalProject(filePath, projectName, testType);
		Logger.println(SwiftImportFromZip.class, "TestAimport()", "HttpResult is: " + HttpResult);
		assertTrue(HttpResult == HttpURLConnection.HTTP_ACCEPTED);
		}catch(Exception e) {
			Logger.println(SwiftImportFromZip.class, "TestAimport()", "Exception occurred during project import: " + e.getMessage(),e);
	...
	public void TestBcheckForProject() {
		try {
			Logger.println(SwiftImportFromZip.class, "TestBcheckForProject()", ">>> SwiftImportFromZip.TestBcheckForProject");
			while(true) {
				...
				Logger.println(SwiftImportFromZip.class, "TestBcheckForProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
	...
	public void TestCcheckForContainer() {
		try {
			Logger.println(SwiftImportFromZip.class, "TestCcheckForContainer()", ">>> SwiftImportFromZip.TestCcheckForContainer");
			...
			assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
				...
				Logger.println(SwiftImportFromZip.class, "TestCcheckForContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestEcheckEndpoint() {
		Logger.println(SwiftImportFromZip.class, "TestEcheckEndpoint()", ">>> SwiftImportFromZip.TestEcheckEndpoint");
		assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
		...
		try {
			while(true) {
				...
				Logger.println(SwiftImportFromZip.class, "TestEcheckEndpoint()", "Exception occurred when checking for endpoint",e);
	...
	public void TestFupdate() {
		Logger.println(SwiftImportFromZip.class, "TestFupdate()", ">>> SwiftImportFromZip.TestFupdate");
		assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
		String expectedString = "UP";
		...
		try {
			...
			Logger.println(SwiftImportFromZip.class, "TestFupdate()", "Exception occurred when checking for endpoint: ",e);
			fail("Exception occurred when checking for endpoint");
		}
	}
	...
	public void TestGdelete() {
		Logger.println(SwiftImportFromZip.class, "TestGdelete()", ">>> SwiftImportFromZip.TestGdelete");
		...
		if (MicroclimateTestUtils.retryCount == retry.getRetriesLeft()) {
			try {
				...
				Logger.println(SwiftImportFromZip.class, "TestGdelete()", "Exception occurred during project deletion: " + e.getMessage(),e);
		...
		if (testType.equalsIgnoreCase("local")) {
			...
			try {
				...
				Logger.println(SwiftImportFromZip.class, "TestGdelete()", "Exception occurred during check if container still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromZip.class, "TestGdelete()", "Exception occurred during check if image still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromZip.class, "TestGdelete()", "Exception occurred during get pod: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SwiftImportFromZip.class, "TestGdelete()", "Exception occurred during check if pod still exists: " + e.getMessage(),e);

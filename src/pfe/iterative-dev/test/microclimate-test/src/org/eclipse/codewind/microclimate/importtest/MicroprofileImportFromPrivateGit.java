...
public class MicroprofileImportFromPrivateGit {


	private static String exposedPort;
	private static String projectName = "javaliberty" + SUITE_TYPES.importtest;
	...
	public void TestAimportFromGit(){
		...
		String urlParameters  ="{\"repo\": \"" + MicroclimateTestUtils.microprofilePrivateRepo + "\",\"name\": \"" + projectName + "\",\"access_token\": \"" + MicroclimateTestUtils.accessToken +"\"}";
		try {
		...
		assertTrue(HttpResult == HttpURLConnection.HTTP_OK);
			...
			Logger.println(MicroprofileImportFromPrivateGit.class, "TestAimportFromGit()", "Exception occurred during project import: " + e.getMessage(),e);
	...
	public void TestBcheckForProject() {
		try {
			while(true) {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestBcheckForProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
	...
	public void TestCcheckForContainer() {
		try {
			...
			assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestCcheckForContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestEcheckEndpoint() {
		...
		try {
			while(true) {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestEcheckEndpoint()", "Exception occurred when checking for endpoint",e);
	...
	public void TestFupdate() {
		...
		try {
			...
			Logger.println(MicroprofileImportFromPrivateGit.class, "TestFupdate()", "Exception occurred when checking for endpoint",e);
			fail("Exception occurred when checking for endpoint");
		}
	}
	...
	public void TestGdelete() {
		...
		if (MicroclimateTestUtils.retryCount == retry.getRetriesLeft()) {
			try {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestGdelete()", "Exception occurred during project deletion: " + e.getMessage(),e);
		...
		if (testType.equalsIgnoreCase("local")) {
			...
			try {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestGdelete()", "Exception occurred during check if container still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestGdelete()", "Exception occurred during check if image still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestGdelete()", "Exception occurred during get pod: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestGdelete()", "Exception occurred during check workspace: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(MicroprofileImportFromPrivateGit.class, "TestGdelete()", "Exception occurred during check if pod still exists: " + e.getMessage(),e);

...
public class NodeJSImportFromPrivateGit {
	private static String exposedPort;
	private static String projectName = "nodejs" + SUITE_TYPES.importtest;
	...
	public void TestAimportFromGit(){
		...
		String urlParameters  ="{\"repo\": \"" + MicroclimateTestUtils.nodePrivateRepo+"\",\"name\": \"" + projectName +"\",\"access_token\": \"" + MicroclimateTestUtils.accessToken +"\"}";
		try {
			...
			Logger.println(NodeJSImportFromPrivateGit.class, "TestAimportFromGit()", "Exception occurred during project import: " + e.getMessage(),e);
	...
	public void TestBcheckForProject() {
		try {
			while(true) {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestBcheckForProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
	...
	public void TestCcheckForContainer() {
		try {
			...
			assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestCcheckForContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestDcheckEndpoint() {
		...
		try {
			while(true) {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestDcheckEndpoint()", "Exception occurred when checking for endpoint",e);
	...
	public void TestEupdate() {
		...
		try {
			...
			Logger.println(NodeJSImportFromPrivateGit.class, "TestEupdate()", "Exception occurred when checking for endpoint",e);
			fail("Exception occurred when checking for endpoint");
		}
	}
	...
	public void TestFdelete() {
		...
		if (MicroclimateTestUtils.retryCount == retry.getRetriesLeft()) {
			try {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestFdelete()", "Exception occurred during project deletion: " + e.getMessage(),e);
		...
		if (testType.equalsIgnoreCase("local")) {
			...
			try {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestFdelete()", "Exception occurred during check if container still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestFdelete()", "Exception occurred during check if image still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestFdelete()", "Exception occurred during get pod: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestFdelete()", "Exception occurred during check workspace: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(NodeJSImportFromPrivateGit.class, "TestFdelete()", "Exception occurred during check if pod still exists: " + e.getMessage(),e);

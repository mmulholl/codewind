...
public class SpringImportFromPublicGit {

	private static String exposedPort;
	private static String projectName = "testspring" + SUITE_TYPES.importtest;
	...
	public void TestAimportFromGit(){
		...
		String urlParameters  ="{\"repo\": \"" + MicroclimateTestUtils.springPublicRepo+"\",\"name\": \"" + projectName +"\"}";
		try {
			...
			Logger.println(SpringImportFromPublicGit.class, "TestAimportFromGit()", "Exception occurred during project import: " + e.getMessage(),e);
	...
	public void TestBcheckForProject() {
		try {
			while(true) {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestBcheckForProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
	...
	public void TestCcheckForContainer() {
		try {
			...
			assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
				...
				Logger.println(SpringImportFromPublicGit.class, "TestCcheckForContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestEcheckEndpoint() {
		...
		try {
			while(true) {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestEcheckEndpoint()", "Exception occurred when checking for endpoint",e);
	...
	public void TestFupdate() {
		...
		try {
			...
			Logger.println(SpringImportFromPublicGit.class, "TestFupdate()", "Exception occurred when checking for endpoint: ",e);
			fail("Exception occurred when checking for endpoint");
		}
	}
	...
	public void TestGdelete() {
		...
		if (MicroclimateTestUtils.retryCount == retry.getRetriesLeft()) {
			try {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestGdelete()", "Exception occurred during project deletion: " + e.getMessage(),e);
		...
		if (testType.equalsIgnoreCase("local")) {
			...
			try {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check if container still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check if image still exists: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestGdelete()", "Exception occurred during get pod: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check workspace: " + e.getMessage(),e);
			...
			try {
				...
				Logger.println(SpringImportFromPublicGit.class, "TestGdelete()", "Exception occurred during check if pod still exists: " + e.getMessage(),e);

...
module.exports = class Project {
  ...
  projectPath(inPortal) {
    ...
    // Microclimate workspace is hardcoded in filewatcherDeployment.js
    return (inPortal ? this.workspace + this.directory :  `/microclimate-workspace/${this.directory}` );
  }
  ...
  getBuildLogPath() {
    ...
    return this.buildLogPath.replace('/microclimate-workspace/', global.microclimate.CODEWIND_WORKSPACE);
  }
